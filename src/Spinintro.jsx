    ...
    <div className="flex flex-col justify-center items-center gap-16">
      ...
      {/* <button className="" onClick={() => navigate('/Spin')}>Go get yourself a gift</button> */}
       ...
       <div className="next-prev-btn flex items-center justify-center space-x-24">
              ...
              <button className="bg-[#94B4C1] py-4 px-8 rounded-md shadow-div-shadow transform hover:scale-105 hover:bg-[#332D56] transition duration-300"  onClick={()=>navigate('/Spin')}>Pick a gift for yourself</button>
          </div>
