  ...
  return (
    ...
    <div class="relative z-10 min-h-screen flex items-center justify-center p-8 items-center pb-12">
        ...
        <div id="gift-card"  class="bg-white/80 backdrop-blur-sm rounded-md p-8 max-w-md w-full text-center shadow-xl">
            ...
            <div class="w-16 h-1 mx-auto bg-yellow-100 rounded-full flex items-center justify-center">
                    {/* <!-- Background container --> */}
                <div class="fixed inset-0 -z-10 overflow-hidden">
                    {/* <!-- Large blob top-left --> */}
                    <div class="absolute -top-32 -left-32 w-96 h-96 bg-yellow-200/60 rounded-full blob-1">
                    </div>
                    
                    {/* <!-- Medium blob top-center --> */}
                    <div class="absolute -top-16 left-1/2 transform -translate-x-1/2 w-64 h-64 bg-yellow-100/80 rounded-full blob-2"></div>
                    
                    {/* <!-- Small blob bottom-right --> */}
                    <div class="absolute -bottom-24 -right-24 w-80 h-80 bg-yellow-200/50 rounded-full blob-3"></div>
                    
                    {/* <!-- Additional subtle blob --> */}
                    <div class="absolute top-1/3 -left-20 w-48 h-48 bg-yellow-100/40 rounded-full blob-4"></div>
                    
                    {/* <!-- Extra decorative elements --> */}
                    <div class="absolute top-2/3 right-1/4 w-32 h-32 bg-yellow-50/60 rounded-full"></div>
                    <div 
                    class="absolute bottom-1/4 left-1/3 w-24 h-24 bg-yellow-100/30 rounded-full"></div>
                </div>
                </div>
                    <div className="w-32 h-32 text-yellow-600 mx-auto ">
                          <img className="rounded-md w-32 h-32 lg:w-32 lg:h-32 hover:scale-105 transform transition duration-500" src={candle} />
                  </div>
                  </div>
                  
                 
            
            <h1 class="text-3xl font-bold text-yellow-600 mb-6"> Guardian of the Flame</h1>
            
            <p class="text-gray-700 text-lg mb-8 font-bold">You’ve been gifted a birthday candle to light up the dance floor for DevTimmy’s celebration! 🕺🎂🔥</p>
            ...
            <div class="space-y-4">
                      <button
                          className=" download-btn w-full bg-yellow-500 hover:bg-emerald-600 text-white font-semibold py-3 px-6 rounded-xl transition-colors flex items-center justify-center gap-2"
