         ...
         <div id="gift-card"  class="bg-white/80 backdrop-blur-sm rounded-md p-8 max-w-md w-full text-center shadow-xl">
             ...
             <div class="w-16 h-1 mx-auto bg-pink-100 rounded-full flex items-center justify-center">
                 ...
                 <div class="fixed inset-0 -z-10 overflow-hidden">
                     ...
                     <div className="w-24 h-24 text-pink-600 mx-auto ">
                        <img className="rounded-md w-24 h-24 lg:w-24 lg:h-24 hover:scale-105 transform transition duration-500" src={karaoke} />
                   </div>
                   </div>
