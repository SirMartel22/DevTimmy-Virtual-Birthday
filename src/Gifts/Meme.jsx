      ...
      return (
        ...
        <div class="relative z-10 min-h-screen flex items-center justify-center p-8 items-center">
            ...
            <div id="gift-card"  class="bg-white/80 backdrop-blur-sm rounded-md p-8 max-w-md w-full text-center shadow-xl">
                ...
                <div class="w-16 h-1 mx-auto bg-blue-100 rounded-full flex items-center justify-center">
                        {/* <!-- Background container --> */}
                    <div class="fixed inset-0 -z-10 overflow-hidden">
                        {/* <!-- Large blob top-left --> */}
                        <div class="absolute -top-32 -left-32 w-96 h-96 bg-blue-200/60 rounded-full blob-1">
                        </div>
                        
                        {/* <!-- Medium blob top-center --> */}
                        <div class="absolute -top-16 left-1/2 transform -translate-x-1/2 w-64 h-64 bg-blue-100/80 rounded-full blob-2"></div>
                        
                        {/* <!-- Small blob bottom-right --> */}
                        <div class="absolute -bottom-24 -right-24 w-80 h-80 bg-blue-200/50 rounded-full blob-3"></div>
                        
                        {/* <!-- Additional subtle blob --> */}
                        <div class="absolute top-1/3 -left-20 w-48 h-48 bg-blue-100/40 rounded-full blob-4"></div>
                        
                        {/* <!-- Extra decorative elements --> */}
                        <div class="absolute top-2/3 right-1/4 w-32 h-32 bg-blue-50/60 rounded-full"></div>
                        <div 
                ...
                <h1 class="text-3xl font-bold text-blue-600 mb-6"> Meme Lord of the Moment </h1>
                
                <p class="text-gray-700 text-lg mb-8 font-bold"> Your face alone deserves a sticker pack. Every reaction was a meme in motion! 📸🤣🔥</p>
                ...
                <div class="space-y-4">
                          <button
                              className=" download-btn w-full bg-blue-500 hover:bg-emerald-600 text-white font-semibold py-3 px-6 rounded-xl transition-colors flex items-center justify-center gap-2"
          ...
          <button className="bg-[#27548A]  py-4 px-8 rounded-md shadow-div-shadow transform hover:scale-105 hover:bg-[#332D56] transition duration-300" onClick={() => navigate('../Thanks')}> Proceed to Checkout </button>
