...
import megaphone  from "../assets/megaphone.jpg"
        ...
        <div id="gift-card"  class="bg-white/80 backdrop-blur-sm rounded-md p-8 max-w-md w-full text-center shadow-xl">
            ...
            <div class="w-16 h-1 mx-auto bg-emerald-100 rounded-full flex items-center justify-center">
                ...
                <div class="fixed inset-0 -z-10 overflow-hidden">
                    {/* <!-- Large blob top-left --> */}
                    <div class="absolute -top-32 -left-32 w-96 h-96 bg-purple-200/60 rounded-full blob-1">
                    </div>
                    
                    {/* <!-- Medium blob top-center --> */}
                    <div class="absolute -top-16 left-1/2 transform -translate-x-1/2 w-64 h-64 bg-purple-100/80 rounded-full blob-2"></div>
                    
                    {/* <!-- Small blob bottom-right --> */}
                    <div class="absolute -bottom-24 -right-24 w-80 h-80 bg-purple-200/50 rounded-full blob-3"></div>
                    
                    {/* <!-- Additional subtle blob --> */}
                    <div class="absolute top-1/3 -left-20 w-48 h-48 bg-purple-100/40 rounded-full blob-4"></div>
                    
                    {/* <!-- Extra decorative elements --> */}
                    <div class="absolute top-2/3 right-1/4 w-32 h-32 bg-purple-50/60 rounded-full"></div>
                    <div 
                    class="absolute bottom-1/4 left-1/3 w-24 h-24 bg-purple-100/30 rounded-full"></div>
                </div>
                </div>
                    <div className="w-24 h-24 text-purple-600 mx-auto ">
                      <img className="rounded-md w-24 h-24 lg:w-24 lg:h-24 hover:scale-105 transform transition duration-500" src={megaphone} />
                  </div>
                  </div>
                  
                 
            
            <h1 class="text-3xl font-bold text-purple-600 mb-6">Commander of Vibes & Volume</h1>
           ...
           <div className="w-32 h-32 text-orange-600 mx-auto ">
            ...
            <div class="space-y-4">
                      <button
                          className=" download-btn w-full bg-purple-500 hover:bg-emerald-600 text-white font-semibold py-3 px-6 rounded-xl transition-colors flex items-center justify-center gap-2"
