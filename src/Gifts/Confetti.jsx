        ...
        <div id="gift-card"  class="bg-white/80 backdrop-blur-sm rounded-md p-8 max-w-md w-full text-center shadow-xl">
            ...
            <div class="w-16 h-1 mx-auto bg-purple-100 rounded-full flex items-center justify-center">
                ...
                <div class="fixed inset-0 -z-10 overflow-hidden">
                    ...
                    <div className="w-32 h-32 text-purple-600 mx-auto ">
                        <img className="rounded-md w-32 h-32 lg:w-32 lg:h-32 hover:scale-105 transform transition duration-500" src={confetti} />
                  </div>
                  </div>
