    ...
    return (
      <div>
        ...
        <div className="throwbackform flex flex-col justify-center items-center space-y-24">
          ...
          <div className="displayCard-Form gap-12 flex flex-col lg:flex lg:flex-row md:flex md:flex-col justify-center items-center space-x-12">
          ...
          <p className="font-bold text-center"> Click on Go to Download Page 🚀 to grab the throwback you sent ✨. if you like what you see? download and share on your whatsApp Status 🥳📱!</p>
           ...
           <div className="next-prev-btn flex flex-col lg:flex lg:flex-row items-center justify-center space-y-16 lg:space-x-24 lg:space-y-0">
              ...
              <button className="bg-[#27548A] py-4 px-8 rounded-md shadow-div-shadow transform hover:scale-105 hover:bg-[#332D56] transition duration-300"  onClick={()=>navigate('/Admin/Download')}>Go to Download Page</button>
          </div>
