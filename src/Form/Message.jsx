        ...
        <div className="message-form-header">
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="next-prev-btn flex flex-col lg:flex lg:flex-row items-center justify-center space-y-16 lg:space-x-24 lg:space-y-0">
                ...
                <button className="bg-[#27548A] bg-[#94B4C1] py-4 px-8 rounded-md shadow-div-shadow transform hover:scale-105 hover:bg-[#332D56] transition duration-300"  onClick={()=>navigate('/Spinintro')}>Pick a gift for yourself</button>
              </div>
      </div>
    </div>
)
